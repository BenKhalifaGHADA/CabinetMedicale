                    ...
                    <div className="row">
                        ...
                        <div classNameName="col-sm-6">
                            <div classNameName="form-group">
                                ...
                                <input classNameName="form-control" type="text" value="Baker" />
                            </div>
                        </div>
                        <div classNameName="col-sm-6">
                            <div className="form-group">
                                <label>Username <span className="text-danger">*</span></label>
                                <input className="form-control" type="text" value="terrybaker" />
                            </div>
                        </div>
                        <div className="col-sm-6">
                            <div className="form-group">
                                <label>Email <span className="text-danger">*</span></label>
                                <input className="form-control" type="email" value="terrybaker@example.com" />
                            </div>
                        </div>
                        <div className="col-sm-6">
                            <div className="form-group">
                        ...
                        <div className="col-sm-12">
                            <div className="row">
                                <div className="col-sm-12">
                                    <div className="form-group">
                                        <label>Address</label>
                                        <input type="text" className="form-control" value="555 Front St #APT 2H, Hempstead" />
                                    </div>
                                </div>
                                ...
                                <div className="col-sm-6 col-md-6 col-lg-3">
                                    <div className="form-group">
                                        ...
                                        <input type="text" className="form-control" value="11550" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className="col-sm-6">
                            <div className="form-group">
                                <label>Phone </label>
                                <input className="form-control" type="text" value="3761506975" />
                            </div>
                        </div>
                        <div className="col-sm-6">
                            <div className="form-group">
