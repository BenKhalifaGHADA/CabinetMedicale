...
class Editpatient extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (nextProps.patient) {
      ...
      patientdata.firstname = !isEmpty(patientdata.firstname)
      ...
      patientdata.state = !isEmpty(patientdata.state) ? patientdata.state : '';

      patientdata.country = !isEmpty(patientdata.country) ? patientdata.country : '';
      patientdata.gender = !isEmpty(patientdata.gender) ? patientdata.gender : '';

      patientdata.phone = !isEmpty(patientdata.phone) ? patientdata.phone : '';
      patientdata.Datebirth = !isEmpty(patientdata.Datebirth)
        ? patientdata.Datebirth
        : '';
      patientdata.avatar = !isEmpty(patientdata.avatar) ? patientdata.avatar : '';
