...
class MyProfile extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (nextProps.profile.profile) {
      ...
      profile.region = !isEmpty(profile.address.region) ? profile.address.region : '';
      ...
      profile.ZipCode = !isEmpty(profile.address.ZipCode) ? profile.address.ZipCode : '';
            ...
            <div className='col-sm-5 col-6 text-right m-b-30'>
              <Link
                to={{
                  ...
                  myprofile: { ...this.props.profile.profile },
                }}
                  ...
                  <div className='profile-img-wrap'>
                    <div className='profile-img'>
                      <a href='#'>
                        <img
                          className='avatar'
                          src={`/${this.props.profile.profile.profilephoto}`}
                          alt=''
                        />
                      </a>
                    </div>
                      ...
                      <div className='col-md-7'>
                        <ul className='personal-info'>
                          ...
                          <li>
                            ...
                            <span className='text'><Moment format="YYYY/MM/DD">{this.state.birthdate}</Moment></span>
                          </li>
                          <li>
                            <span className='title'>Address:</span>
                            <span className='text'>
                              {this.state.region} {this.state.Country} {this.state.State}{' '}
                              {this.state.ZipCode}{' '}
                            </span>
                          </li>
                          <li>
