...
//create drug
  ...
  const removeHandler = index => {
    ...
    const newArr = todoList.filter((index, itemIndex) => {
...
setTodoList(newArr);
  ...
  const taskList = todoList.map((index,item) => {
    return (
        <tr key={index} onClick={removeHandler.bind(this, index)} >
   ...
   <div>
         ...
         <h3 className="card-title">Create ordonnance
         <button className="fa fa-plus add-line" onClick={addTaskHandler} ></button></h3>
      {/* </form> */}
      <div className="row">
              <div className="table-responsive">
                            <table id="tab" className="align-middle mb-0 table table-borderless table-striped table-hover">
                                <thead>
                                <tr>
